...
public class ZooKeeperServerMain {
    ...
    public static void main(String[] args) {
        //加载zookeeper配置文件
        args = new String[1];
        args[0] = "D:\\google_download\\myZookeeper-master\\config\\zoo.cfg";
        //加载日志配置文件
        PropertyConfigurator.configure("D:\\google_download\\myZookeeper-master\\src\\main\\java\\org\\apache\\zookeeper\\log\\log4j.properties");
